...
files.forEach(function(file) {
    if (file.indexOf('precache-manifest') >= 0) {
        precacheName = file
    }
})
...
app.use('/registerServiceWorker.js', serve('./dist/registerServiceWorker.js'))
app.use('/precache-manifest.*.js', serve('./dist/' + precacheName))
// app.use(
//     '//precache-manifest.*[^(.js)]$/,',
//     serve('//./dist/precache-manifest.*[^(.js)]$/,')
// )
